...
public class EnemyShipBigGreen extends EnemyShipBasic {
    ...
    public EnemyShipBigGreen(Coords coords, PlayerShip psRef, Coords targetCoords) {
        super(coords, 26 * 2, 26 * 2, "images/sprites/ships/ship_big_2.png", 250, targetCoords, psRef);
    }
